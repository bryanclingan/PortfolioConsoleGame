        ...
        public Enemy(string name,  EnemyLV level ) : base(name)
        {
            ...
            switch (Level)
            {
                case EnemyLV.Easy:
                    ...
                    System.Threading.Thread.Sleep(50);
                    LootDropRate = new Random().Next(21);
                    System.Threading.Thread.Sleep(50);
                    ArmorWeaponDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
                    MagicItemDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
                    HPPotDropRate = new Random().Next(21);
                    System.Threading.Thread.Sleep(50);
                ...
                case EnemyLV.Medium:
                    ...
                    System.Threading.Thread.Sleep(50);
                    LootDropRate = new Random().Next( 31);
                    System.Threading.Thread.Sleep(50);
                    ArmorWeaponDropRate = new Random().Next(31);
                    System.Threading.Thread.Sleep(50);
                    MagicItemDropRate = new Random().Next(31);
                    System.Threading.Thread.Sleep(50);
                    HPPotDropRate = new Random().Next(31);
                    System.Threading.Thread.Sleep(50);
                ...
                case EnemyLV.Hard:
                    ...
                    System.Threading.Thread.Sleep(50);
                    LootDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
                    ArmorWeaponDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
                    MagicItemDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
                    HPPotDropRate = new Random().Next(41);
                    System.Threading.Thread.Sleep(50);
